...
const TAREAS: TareaConEstado[] = [
  { id: "t1", asignatura_id: "cal", titulo: "Guía 4 · Optimización",
    ...
    puntos: 20, vence_en: enDias(3), entregada_en: null, puntos_obtenidos: null, entregado: null },
  { id: "t2", asignatura_id: "cal", titulo: "Control 2 · Derivadas",
    enunciado: "Control escrito sobre reglas de derivación.", criterios: [],
    puntos: 30, vence_en: enDias(-7), entregada_en: enDias(-7), puntos_obtenidos: 27, entregado: null },
  { id: "t3", asignatura_id: "alg", titulo: "Guía 2 · Independencia lineal",
    ...
    puntos: 15, vence_en: enDias(1), entregada_en: null, puntos_obtenidos: null, entregado: null },
  { id: "t4", asignatura_id: "fis", titulo: "Informe de laboratorio 2",
    ...
    puntos: 25, vence_en: enDias(2), entregada_en: null, puntos_obtenidos: null, entregado: null },
  ...
  { id: "t6", asignatura_id: "io", titulo: "Caso 1 · Mezcla de producción",
    ...
    puntos: 20, vence_en: enDias(7), entregada_en: null, puntos_obtenidos: null, entregado: null },
  { id: "t7", asignatura_id: "mic", titulo: "Control 2 · Elasticidad",
    enunciado: "Control en sala sobre elasticidad.", criterios: [],
    puntos: 25, vence_en: enDias(1), entregada_en: null, puntos_obtenidos: null, entregado: null },
  { id: "t8", asignatura_id: "pro", titulo: "Tarea 3 · Análisis de datos",
    ...
    puntos: 30, vence_en: enDias(3), entregada_en: null, puntos_obtenidos: null, entregado: null },
  { id: "t9", asignatura_id: "pro", titulo: "Tarea 2 · Estructuras",
    enunciado: "Inventario con diccionarios.", criterios: [],
    puntos: 30, vence_en: enDias(-10), entregada_en: enDias(-10), puntos_obtenidos: 29, entregado: null },
];
